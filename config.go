...
type Config struct {
	...
	IsMacOS     MatchFunc      `yaml:"isMacOs"`
	IsWindows64 MatchFunc      `yaml:"isWindows64"`
	IsWindows32 MatchFunc      `yaml:"isWindows32"`
	DSAKey      string         `yaml:"dsaKey"`
	EdKey       string         `yaml:"edKey"`
